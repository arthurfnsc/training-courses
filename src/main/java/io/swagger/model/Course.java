...
public class Course {
    ...
    public boolean equals(final Object o) {
        ...
        return Objects.equals(this.name, course.name) && Objects.equals(this.description, course.description) && Objects.equals(this.duration, course.duration);
    }

    @Override
    public int hashCode() {
        return Objects.hash(this.name, this.description, this.duration);
    }
